      ...
      <Navbar id="myNav">
        <Navbar.Brand onClick={() => onRouteChange("Personal Schedule")} /*href="#p"*/ id='navbrand'>
          ...
          <h1 id="brandTitle" className="d-inline-block align-top">MeniSked</h1>
            ...
            <img onClick={() => this.props.onRouteChange(ad+"Messages")} alt="Messages" src="https://img.icons8.com/?size=512&id=53388&format=png" width="30" height="30" className="logo linky"/>
